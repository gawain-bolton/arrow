 ...
 protected:
  ...
  std::shared_ptr<schema::GroupNode> GetSchema() {
    ...
    fields.push_back(schema::PrimitiveNode::Make("uint64_field", Repetition::REQUIRED,
                                                 Type::INT64, LogicalType::UINT_64));
...
TEST_F(TestReadingDataFiles, AllTypesPlain) {
  ...
  PARQUET_THROW_NOT_OK(
      arrow::io::ReadableFile::Open(GetDataFile("alltypes_plain.parquet"), &infile));
...
TEST_F(TestReadingDataFiles, Int32Decimal) {
  ...
  PARQUET_THROW_NOT_OK(
      arrow::io::ReadableFile::Open(GetDataFile("int32_decimal.parquet"), &infile));
...
TEST_F(TestReadingDataFiles, Int64Decimal) {
  ...
  PARQUET_THROW_NOT_OK(
      arrow::io::ReadableFile::Open(GetDataFile("int64_decimal.parquet"), &infile));
